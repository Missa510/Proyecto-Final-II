<?php require_once("Controlador/control_modersEst.php"); ?>
<div class="tab">
            ...
            while ($row = mysqli_fetch_assoc($mostrar_var)) {
                ...
                <?php } else { ?>
                    <tr>
                        ...
                        <td> <a href="?control=modificar&&funcion=modificar&&id_mod=<?= $row["id_mod"]; ?>&&type=Moder"
                        ...
                        <td> <a href="?control=eliminar&&funcion=eliminar&&id_mod=<?= $row["id_mod"]; ?>&&type=Moder"
    ...
    <a href="?control=navegacion&&funcion=registroModer" class="btn btn-warning">Agregar nuevo moderador &plus; </a>
</div>