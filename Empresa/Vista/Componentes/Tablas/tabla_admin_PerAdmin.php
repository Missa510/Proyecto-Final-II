<?php require_once("Controlador/control_adminEst.php"); ?>
<div class="tab">
            ...
            while ($row = mysqli_fetch_assoc($mostrar_var)) {
                ...
                <?php } else { ?>
                    <tr>
                        ...
                        <td> <a href="mailto:<?= $row["mail_admin"]; ?>" class="link-light"> <?= $row["mail_admin"]; ?> </a>
                        </td>
                        <td>
                            <?= $row["estado_nom"]; ?>
                        </td>
                        <td> <a href="?control=modificar&&funcion=modificar&&id_admin=<?= $row["id_admin"]; ?>&&type=Admin"
                        ...
                        <td> <a href="?control=eliminar&&funcion=eliminar&&id_admin=<?= $row["id_admin"]; ?>&&type=Admin"
    ...
    <a href="?control=navegacion&&funcion=registroAdmin" class="btn btn-warning">Agregar nuevo administrador &plus; </a>
</div>