...
<main>
    <div class="main-puro">
        <div class="cardeta">
            <h1 class="display-1 text-center" id="titulo">Registro de Usuarios</h1>
            ...
            <form action="?control=registro&&funcion=registroUser" method="post">
                ...
                <div class="row g-2 mb-4">
                    ...
                    <div class="form-floating col">
                        ...
                        <div class="form-text text-dark">Solo Usuarios Corrientes</div>
                    </div>
