...
<main>
    <div class="main-puro">
        <div class="cardeta">
            <h1 class="display-1 text-center" id="titulo">Registro de Moderadores</h1>
            ...
            <form action="?control=registro&&funcion=registroModer" method="post">
                ...
                <div class="row g-2 mb-4">
                    ...
                    <div class="form-floating col">
                        ...
                        <div class="form-text text-dark">Solo Moderadores</div>
                    </div>
