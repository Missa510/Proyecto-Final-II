<h1 class="Header">Cargos de cada sede</h1>
<div class="container-fluid">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-warning"
                                href="?control=cargos&&funcion=Editar&&id=<?= $BuryTherlight["id_cargo"]; ?>"> <svg
                        ...
                        <td>
                            <a class="btn btn-outline-danger"
                                href="?control=cargos&&funcion=ConfirmarEliminacion&&id=<?= $BuryTherlight["id_cargo"]; ?>"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <form action="?control=cargos&&funcion=Agregar" class="formulario-add" method="post">
        <div class="mb-3">
            ...
            <input type="text" name="cargo" id="id_cargo" class="form-control">
        </div>
        <div class="mb-3">
            <label for="id_sueldo" class="form-label">Sueldo (COP)</label>
            <input type="number" min="800000" name="sueldo" id="id_sueldo" class="form-control">
        </div>
        <div class="mb-3">
            <label for="id_descripcion" class="form-label">Pequeña descripción del cargo</label>
