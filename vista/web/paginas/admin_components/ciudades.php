<h1 class="Header">Ciudades en donde estamos</h1>
<div class="container-fluid">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-warning"
                                href="?control=ciudades&&funcion=Editar&&id=<?= $BuryTherlight["id_ciu"]; ?>"><svg
                        ...
                        <td>
                            <a class="btn btn-outline-danger"
                                href="?control=ciudades&&funcion=ConfirmarEliminacion&&id=<?= $BuryTherlight["id_ciu"]; ?>">
    ...
    <h1 class="display-6">Añadir una nueva ciudad</h1>
    <form action="?control=ciudades&&funcion=Agregar" class="formulario-add" method="post">
        <div class="ciudad">
            <label for="id_ciudad" class="form-label">Ciudad</label>
            <input type="text" name="ciudad" id="id_ciudad" class="form-control">
        </div>
        <div class="capital mb-3">
            <label for="id_capital" class="form-label">Capital</label>
            <input type="text" name="capital" id="id_capital" class="form-control">
        </div>
