<h1 class="Header">Sedes que manejamos</h1>
<div class="container-fluid">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-warning" href="?control=sedes&&funcion=Editar&&id=<?= $BuryTherlight["id_sede"]; ?>">
                        ...
                        <td>
                            <a class="btn btn-outline-danger" href="?control=sedes&&funcion=ConfirmarEliminacion&&id=<?= $BuryTherlight["id_sede"]; ?>">
    ...
    <h1 class="display-6">Añadir una nueva sede</h1>

    <form action="?control=sedes&&funcion=Agregar" class="formulario-add" method="post">
        <div class="mb-3">
            <label for="id_sede" class="form-label">Nombre</label>
            <input type="text" name="sede" id="id_sede" class="form-control">
        </div>
        <div class="mb-3">
            <label for="id_ciudad" class="form-label">Ciudades</label>
