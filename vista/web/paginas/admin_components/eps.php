<h1 class="Header">EPS que podemos aceptar</h1>
<div class="container-fluid">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-warning"
                                href="?control=eps&&funcion=Editar&&id=<?= $BuryTherlight["id_eps"]; ?>">
                        ...
                        <td>
                            <a class="btn btn-outline-danger"
                                href="?control=eps&&funcion=ConfirmarEliminacion&&id=<?= $BuryTherlight["id_eps"]; ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <h1 class="display-6">Añadir una nueva EPS</h1>
    <form action="?control=eps&&funcion=Agregar" class="formulario-add" method="post">
        <div class="mb-3">
            <label for="id_eps" class="form-label">EPS</label>
            <input type="text" name="eps" id="id_eps" class="form-control">
        </div>
